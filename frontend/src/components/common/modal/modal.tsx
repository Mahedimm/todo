...
const Modal: FC<ModalProps> = ({
	...
	useOnClickOutside(modalInnerRef, () => console.log("clicked"));
							...
							>
								{onClose ? (
									<button
										...
										className={cn(
											"absolute z-10 inline-flex items-center justify-center w-7 h-7 md:w-8 md:h-8 rounded-full bg-white shadow text-gray-600 transition duration-200 focus:outline-none focus:text-gray-800 focus:shadow-md hover:text-gray-800 hover:shadow-md",
